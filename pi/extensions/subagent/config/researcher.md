...
tools: searxng_web_search, searxng_search_suggestions, searxng_instance_info, web_url_read
permission: subagent
...
2. Search with SearXNG tools using varied angles
3. Read the answers. Identify what's well-covered, what has gaps.
4. For the 2-3 most promising source URLs, use `web_url_read` to get full page content
